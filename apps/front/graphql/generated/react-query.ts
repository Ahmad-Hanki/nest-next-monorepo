...
export type PostQuery = {
  ...
  post: {
    ...
    likes?: Array<{ __typename?: "Like"; id: number } | null> | null;
  };
};
...
export const useCreateUserMutation = <TError = XiorError, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateUserMutationVariables) =>
      reactQueryFetcher<CreateUserMutation, CreateUserMutationVariables>(
        CreateUserDocument,
        variables
      )(),
    ...options,
...
export const useRefreshTokenMutation = <TError = XiorError, TContext = unknown>(
  options?: UseMutationOptions<
  ...
  >({
    ...
    mutationFn: (variables?: RefreshTokenMutationVariables) =>
      reactQueryFetcher<RefreshTokenMutation, RefreshTokenMutationVariables>(
...
export const useSignInMutation = <TError = XiorError, TContext = unknown>(
  options?: UseMutationOptions<
    SignInMutation,
    TError,
  ...
  return useMutation<SignInMutation, TError, SignInMutationVariables, TContext>(
    {
      ...
      mutationFn: (variables?: SignInMutationVariables) =>
        reactQueryFetcher<SignInMutation, SignInMutationVariables>(
          SignInDocument,
          variables
        )(),
      ...options,
...
export const usePostsQuery = <TData = PostsQuery, TError = XiorError>(
  ...
  return useQuery<PostsQuery, TError, TData>({
    ...
    queryFn: reactQueryFetcher<PostsQuery, PostsQueryVariables>(
      PostsDocument,
      variables
    ),
    ...options,
...
usePostsQuery.getKey = (variables?: PostsQueryVariables) =>
...
export const usePostQuery = <TData = PostQuery, TError = XiorError>(
  ...
  return useQuery<PostQuery, TError, TData>({
    ...
    queryFn: reactQueryFetcher<PostQuery, PostQueryVariables>(
      PostDocument,
      variables
    ),
    ...options,
...
export const useMeQuery = <TData = MeQuery, TError = XiorError>(
  ...
  return useQuery<MeQuery, TError, TData>({
    ...
    queryFn: reactQueryFetcher<MeQuery, MeQueryVariables>(
      MeDocument,
      variables
    ),
    ...options,
